...
const save = async () => {
  ...
  if (!form.value.content) {
    ui.addToast("Содержание статьи обязательно", "warning");
    return;
  }
  ...
  try {
    ...
    ui.addToast("Статья успешно создана", "success");
    router.push("/admin/blog");
  } catch (e) {
    ui.addToast("Ошибка при создании", "danger");
  } finally {
    saving.value = false;
  }
};
...
<template>
  <div class="p-4 animate-fade-in">
    <div class="d-flex justify-content-between align-items-center mb-4">
      <div>
        <h1 class="h3 fw-bold mb-1">Новая статья</h1>
        <NuxtLink
          to="/admin/blog"
      ...
      >
        ...
        ></span>
        <i v-else class="bi bi-check2-circle me-2"></i> Опубликовать
      </button>
    </div>
